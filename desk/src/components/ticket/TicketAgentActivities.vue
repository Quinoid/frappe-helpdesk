        ...
        <div v-for="(activity, i) in activities" :key="activity.key">
          ...
          >
            <div
              ...
              :class="[
                i != activities.length - 1 ? 'after:h-full' : 'after:h-4',
              ]"
            >
              <div
...
import { CommentBox, EmailArea, HistoryBox } from "@/components";
import {
  ActivityIcon,
  CommentIcon,
  DotIcon,
...
import { Ref, computed, h, inject, onMounted, watch } from "vue";
